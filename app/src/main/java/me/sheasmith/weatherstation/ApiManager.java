...
import me.sheasmith.weatherstation.models.DailyHistory;
import me.sheasmith.weatherstation.models.Forecast;
import me.sheasmith.weatherstation.models.HourlyHistory;
import okhttp3.OkHttpClient;
import okhttp3.Request;
import okhttp3.Response;

/**
 * Created by TheDiamondPicks on 27/02/2019.
 */
public class ApiManager {
        ...
        Thread webThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Request request = new Request.Builder()
                        .url("https://api.weather.com/v2/pws/observations/current?stationId=" + context.getString(R.string.station_id) + "&format=json&units=m&apiKey=" + context.getString(R.string.api_key))
                        .get()
                        .build();
    ...
    public static void getForecast(final ApiResponse<Forecast> callback, Context context) {
        Thread webThread = new Thread(new Runnable() {
            @Override
            public void run() {
                OkHttpClient client = new OkHttpClient();
                ...
                Request request = new Request.Builder()
                        .url("https://api.weather.com/v3/wx/forecast/daily/5day?geocode=" + context.getString(R.string.geocode) + "&units=m&language=en-NZ&format=json&apiKey=" + context.getString(R.string.api_key))
                        .get()
                        .build();

...
/**
 * Created by TheDiamondPicks on 4/03/2019.
 */
public class ForecastCardModel {
    ...
    public ForecastCardModel(String narrative, String windPhrase, String qualifierPhrase, String uvDescription, long epoch, int iconCode) {

...
public class HourlyMetric {
    ...
    @Expose
    public Integer windspeedHigh;
    @SerializedName("windspeedLow")
    @Expose
    public Integer windspeedLow;
    @SerializedName("windspeedAvg")
    @Expose
    public Integer windspeedAvg;
    @SerializedName("windgustHigh")
    @Expose
    public Integer windgustHigh;
    @SerializedName("windgustLow")
    @Expose
    public Integer windgustLow;
    @SerializedName("windgustAvg")
    @Expose
    public Integer windgustAvg;
    @SerializedName("dewptHigh")
    @Expose
    public Integer dewptHigh;
    @SerializedName("dewptLow")
    @Expose
    public Integer dewptLow;
    @SerializedName("dewptAvg")
    @Expose
    public Integer dewptAvg;
    @SerializedName("windchillHigh")
    @Expose
    public Integer windchillHigh;
    @SerializedName("windchillLow")
    @Expose
    public Integer windchillLow;
    @SerializedName("windchillAvg")
    @Expose
    public Integer windchillAvg;
    @SerializedName("heatindexHigh")
    @Expose
    public Integer heatindexHigh;
    @SerializedName("heatindexLow")
    @Expose
    public Integer heatindexLow;
    @SerializedName("heatindexAvg")
    @Expose
    public Integer heatindexAvg;

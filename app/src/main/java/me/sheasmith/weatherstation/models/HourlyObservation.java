...
public class HourlyObservation {
    ...
    @Expose
    public Double solarRadiationHigh;
    @SerializedName("uvHigh")
    @Expose
    public Integer uvHigh;
    @SerializedName("winddirAvg")
    @Expose
    public Integer winddirAvg;
    @SerializedName("humidityHigh")
    @Expose
    public Integer humidityHigh;
    @SerializedName("humidityLow")
    @Expose
    public Integer humidityLow;
